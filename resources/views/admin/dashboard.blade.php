                    ...
                    <div class="clearfix">
                        ...
                        <div class="float-right text-right">
                            <p class="card-text text-dark">Users</p>
                                <h4>
                                    {{(\App\Models\User::count() )?\App\Models\User::count() : 0}}
                                </h4>

                        </div>
                    </div>
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        <i class="fa fa-exclamation-circle mr-1" aria-hidden="true"></i> Number Of Created Users
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="float-right text-right">
                            <p class="card-text text-dark">Categories</p>
                                <h4>
                                    {{(\App\Models\Category::count()  ?\App\Models\Category::count()  : 0 )}}
                                </h4>
                        </div>
                    </div>
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        <i class="fa fa-calendar mr-1" aria-hidden="true"></i> Existed Categories
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="float-right text-right">
                            <p class="card-text text-dark">product</p>
                                <h4>
                                    {{(\App\Models\Product::count())?\App\Models\Product::count() : 0}}
                                </h4>
                        </div>
                    </div>
                    <p class="text-muted pt-3 mb-0 mt-2 border-top">
                        <i class="fa fa-repeat mr-1" aria-hidden="true"></i> Number Of Products
                    </p>
                </div>
            </div>
        </div>
...
{{--    <div class="row">--}}
{{--        <div class="col-12">--}}
{{--            @if(auth('admin')->user()->store_id !== null || auth('admin')->user()->store_id == null)--}}
{{--                <div style="width:75%;">--}}
{{--                    {!! $chartjs->render() !!}--}}
{{--                </div>--}}
{{--            @endif--}}

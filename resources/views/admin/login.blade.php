        ...
        <div class="container">
            <div class="row justify-content-center no-gutters vertical-align">
                <div class="col-lg-4 col-md-6 login-fancy-bg bg"
                     style="background-image: url({{asset('assets/admin/images/login-inner-bg.jpg')}});">
                        ...
                        <form method="POST" action="{{route('admin.loginPost')}}">
                            ...
                            <div class="section-field">
                                <div class="remember-checkbox mb-30">
                                    ...
                                    {{-- <a href="#" class="float-right">did you forget your password</a> --}}
                                </div>
                            </div>
                            <button class="button" name="login"><span>Login</span><i class="fa fa-check"></i></button>
                        </form>
                    </div>
                </div>
            </div>
